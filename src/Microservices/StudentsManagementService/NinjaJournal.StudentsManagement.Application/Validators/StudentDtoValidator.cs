...
{
    private readonly IReadEntityRepository<Guid, Domain.Entities.Group> _readGroupEntityRepository;
    private readonly IReadEntityRepository<Guid, Domain.Entities.Student> _readStudentEntityRepository;

    public StudentDtoValidator(IReadEntityRepository<Guid, Domain.Entities.Group> readEntityRepository, 
        IReadEntityRepository<Guid, Domain.Entities.Student> readStudentEntityRepository)
    {
